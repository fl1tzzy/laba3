...
// Функция для реализации решета Эратосфена
...
// Функция для генерации случайного числа с одной цифрой после запятой в заданном диапазоне
...
// Функция для построения нового числа на основе старого
...
int main() {
    ...
    vector<int> c = resheto(500); // Получение вектора простых чисел до 500

    int bit;
    cin >> bit; // Ввод числа бит
    ...
    // Вывод строки таблицы с новыми числами, построенными на основе простых чисел
    cout << "|";
